...
/**
 * See as reference
 * https://github.com/atom/atom/blob/master/packages/grammar-selector/lib/grammar-list-view.js
 */

 const monacoWorkspace = require('../workspace');
 const monacoGrammars = require('../grammars');

const SelectListView = require('atom-select-list');

export default class MonacoGrammarListView {
  constructor() {
    ...
    this.selectListView = new SelectListView({
      ...
      didConfirmSelection: grammar => {
        ...
        if (grammar === this.autoDetect) {
          ...
          monacoGrammars.assignGrammar(this.editor, grammar);
        }
      },
      didCancelSelection: () => {
        this.cancel();
